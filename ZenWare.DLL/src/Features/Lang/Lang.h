...
namespace Lang
{
	...
	inline const char* T(const char* szEn)
	{
		...
		static const std::map<std::string, std::string> tblRu = {
			...
			{"Common counter","Счётчик обычных"}, {"Spread circle","Круг разброса"}, {"Bind list","Список биндов"}, {"Damage log","Лог урона"}, {"SI class colors","Цвета классов SI"},
		...
		static const std::map<std::string, std::string> tblDe = {
			...
			{"Common counter","Common-Zähler"}, {"Spread circle","Spread-Kreis"}, {"Bind list","Tastenliste"}, {"Damage log","Schadens-Log"}, {"SI class colors","SI-Klassenfarben"},
		...
		static const std::map<std::string, std::string> tblEs = {
			...
			{"Common counter","Contador comunes"}, {"Spread circle","Círculo dispersión"}, {"Bind list","Lista teclas"}, {"Damage log","Registro daño"}, {"SI class colors","Colores clases SI"},
		...
		static const std::map<std::string, std::string> tblPt = {
			...
			{"Common counter","Contador comuns"}, {"Spread circle","Círculo dispersão"}, {"Bind list","Lista teclas"}, {"Damage log","Registro dano"}, {"SI class colors","Cores classes SI"},
			{"Weapon HUD","HUD arma"}, {"Reload alerts","Alertas recarga"},
		...
		static const std::map<std::string, std::string> tblPl = {
			...
			{"Common counter","Licznik zwykłych"}, {"Spread circle","Krąg rozrzutu"}, {"Bind list","Lista klawiszy"}, {"Damage log","Log obrażeń"}, {"SI class colors","Kolory klas SI"},
		...
		static const std::map<std::string, std::string> tblFr = {
			...
			{"Common counter","Compteur communs"}, {"Spread circle","Cercle dispersion"}, {"Bind list","Liste touches"}, {"Damage log","Journal dégâts"}, {"SI class colors","Couleurs classes SI"},
		...
		static const std::map<std::string, std::string> tblZh = {
			...
			{"Common counter","小怪计数"}, {"Spread circle","散布圈"}, {"Bind list","按键列表"}, {"Damage log","伤害记录"}, {"SI class colors","特感职业颜色"},
