...
bool Hovered(const POINT& p,int x,int y,int w,int h){ return p.x>=x&&p.x<=x+w&&p.y>=y&&p.y<=y+h; }
	...
	static const HelpEntry_t kHelp[] = {
		...
		{"Language: English >","Language","Cycles the menu language: English, Russian, German, Spanish.","Язык","Крутит язык меню: английский, русский, немецкий, испанский."},
		{"Language: Russian >","Language","Cycles the menu language: English, Russian, German, Spanish.","Язык","Крутит язык меню: английский, русский, немецкий, испанский."},
		{"Language: German >","Language","Cycles the menu language: English, Russian, German, Spanish.","Язык","Крутит язык меню: английский, русский, немецкий, испанский."},
		{"Language: Spanish >","Language","Cycles the menu language: English, Russian, German, Spanish.","Язык","Крутит язык меню: английский, русский, немецкий, испанский."},
