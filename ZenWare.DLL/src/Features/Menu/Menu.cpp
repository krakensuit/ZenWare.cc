...
bool Hovered(const POINT& p,int x,int y,int w,int h){ return p.x>=x&&p.x<=x+w&&p.y>=y&&p.y<=y+h; }
	...
	static const HelpEntry_t kHelp[] = {
		...
		{"Language: English >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: Russian >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: German >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: Spanish >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: Portuguese >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: Polish >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: French >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
		{"Language: Chinese >","Language","Cycles the menu language: English, Russian, German, Spanish, Portuguese, Polish, French, Chinese.","Язык","Крутит язык меню: английский, русский, немецкий, испанский, португальский, польский, французский, китайский."},
...
void CFeatures_Menu::Render(){
 ...
 //F11 works while the menu is open too (the footer used to lie: polling only happened when closed).
 {
  ...
  if(!Vars::Menu::bOpen && Vars::Menu::bWatermark && G::Draw.m_nScreenW > 0){
    ...
    G::Draw.String(EFonts::MENU_BODY,nWmX+13,nWmY+4,Color(230,245,240,255),TXT_DEFAULT,"%s",szWm);
  }
  return;
 }
 ...
 G::Draw.Rect(m_rc.nX+1,m_rc.nY+2,m_rc.nW,m_rc.nH,CLR_SHADOW);
  ...
  default:{
   ...
   G::Draw.String(EFonts::MENU_BODY,m_rc.nX+20,m_nItemY+6,CLR_TEXT_OFF,TXT_DEFAULT,Lang::T("F11 = unload cheat"));
   m_nItemY+=26; break;
   }
  }
  // Measure tab content for scrolling + thin scrollbar.
  {
   ...
   const int nSX=m_rc.nX+m_rc.nW-Layout::kPadding/2;
...
bool CFeatures_Menu::HelpMark(const MouseState_t& mouse,const char* const szId,const char* const szTitle,const char* const szText,int nX,int nY){
 ...
 G::Draw.String(EFonts::MENU_BODY,nCX,nCY,bOpen?Color(8,14,11,255):(bHov?CLR_ACCENT:CLR_TEXT_OFF),TXT_CENTERXY,"?");
...
void CFeatures_Menu::DrawHelpPopup(const MouseState_t& mouse){
 ...
 if(n<=0) return;
 const int nLineH=G::Draw.GetFontHeight(EFonts::MENU_BODY)+3;
 const int nTitleH=G::Draw.GetFontHeight(EFonts::MENU_BODY)+10;
 int nW=G::Draw.GetTextWidth(EFonts::MENU_BODY,m_szHelpTitle)+28;
 for(int i=0;i<n;i++){ const int w=G::Draw.GetTextWidth(EFonts::MENU_BODY,aLines[i])+28; if(w>nW) nW=w; }
 if(nW>320) nW=320;
 ...
 G::Draw.String(EFonts::MENU_BODY,nX+14,nY+5,CLR_ACCENT,TXT_DEFAULT,"%s",m_szHelpTitle);
 G::Draw.OutlinedRect(nX,nY,nW,nH,CLR_OUTLINE);
 for(int i=0;i<n;i++)
  G::Draw.String(EFonts::MENU_BODY,nX+14,nY+nTitleH+i*nLineH,CLR_TEXT_ON,TXT_DEFAULT,"%s",aLines[i]);
}
void CFeatures_Menu::SectionLabel(const char* const szLabel){
	if (RowClipped(m_nItemY, 20)) { m_nItemY += 20; return; }
	G::Draw.String(EFonts::MENU_BODY,m_rc.nX+12,m_nItemY+2,CLR_TEXT_OFF,TXT_DEFAULT,"%s",Lang::T(szLabel));
...
void CFeatures_Menu::ColorSwatches(const MouseState_t& mouse,const char* const szLabel,Color* pValue){
 ...
 G::Draw.String(EFonts::MENU_BODY,nRowX+12+(int)(2*flHov),m_nItemY+6,CLR_TEXT_OFF,TXT_DEFAULT,"%s",Lang::T(szLabel));
...
void CFeatures_Menu::Button(const MouseState_t& mouse,const char* szLabel,void(*pfnAction)()){
 ...
 G::Draw.String(EFonts::MENU_BODY,nRowX+8+48,m_nItemY+7+(int)(1*flPress),bHover?CLR_ACCENT:CLR_TEXT_ON,TXT_CENTERXY,"%s",Lang::T(szLabel));
 bool bHelp=false;
 if(const HelpEntry_t* he=FindHelp(szLabel))
...
void CFeatures_Menu::BindRow(const MouseState_t& mouse,const char* szLabel,int* pValue){
 ...
 G::Draw.String(EFonts::MENU_BODY,nRowX+12+(int)(2*flHov),m_nItemY+6,CLR_TEXT_ON,TXT_DEFAULT,"%s",Lang::T(szLabel));
 char szVal[32]={};
 ...
 G::Draw.String(EFonts::MENU_BODY,nRowX+nRowW-90,m_nItemY+6,clrVal,TXT_DEFAULT,"%s",szVal);
 bool bHelp=false;
 if(const HelpEntry_t* he=FindHelp(szLabel)){
